"""
Algorithms: DFS for 8-Puzzle (stack-based)
Customized by: Rawf (Student ID: it23050)

Note: Core algorithm function name `dfs` kept unchanged (important).
"""

def dfs(start_state_rawf_it23050: str) -> str:
    goal_state_rawf_it23050 = "123456780"

    stack_rawf = [start_state_rawf_it23050]
    visited_rawf_it23050 = []

    while stack_rawf:
        current_state_rawf = stack_rawf.pop()
        ...
        if current_state_rawf not in visited_rawf_it23050:
            ...
            if blank_index_rawf > 2:
                ...
                stack_rawf.append("".join(next_state_list_rawf))
...
if __name__ == "__main__":
    ...
    print(dfs(start_state_rawf_it23050))
